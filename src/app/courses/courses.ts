            ...
            <igc-accordion ?single-expand="${true}" class="accordion">
              <igc-expansion-panel>
                <igc-list class="list_1">
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_1">
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_2">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_3">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
              ...
              <igc-expansion-panel>
                <igc-list class="list_1">
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_4">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_5">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_6">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_7">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
              ...
              <igc-expansion-panel>
                <igc-list class="list_1">
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_8">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_9">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_10">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_11">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
              ...
              <igc-expansion-panel>
                <igc-list class="list_1">
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_12">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_13">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_14">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_15">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_16">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
              ...
              <igc-expansion-panel>
                <igc-list class="list_1">
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_17">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_18">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_19">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_20">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
              ...
              <igc-expansion-panel>
                <igc-list class="list_1">
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_21">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_22">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_23">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
              ...
              <igc-expansion-panel>
                <igc-list class="list_1">
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_24">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_25">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_26">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_27">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
              ...
              <igc-expansion-panel>
                <igc-list class="list_1">
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_28">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_29">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_30">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                    <div slot="title">Creating a Basic HTML Table</div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_31">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
              ...
              <igc-expansion-panel>
                <igc-list class="list_1">
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_32">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_33">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_34">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_35">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
              ...
              <igc-expansion-panel>
                <igc-list class="list_1">
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_36">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_37">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_38">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_39">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
                  ...
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar shape="circle" class="avatar_1 avatar_1_40">
                        <span class="material-icons">play_circle_outline</span>
                      </igc-avatar>
                    </div>
